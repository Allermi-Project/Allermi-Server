...
public class UserController {
    ...
    @PutMapping(value = "/{id}")
    public UserEntity update(@PathVariable Long id, @RequestParam String userid, @RequestParam String password, @RequestParam String name, @RequestParam String allergy ){
        Optional<UserEntity> userEntity = userRepository.findById(id);
        userEntity.get().setUserid(userid);
